...
<title>Reprecentante Legal</title>
<!-- Link Boostrap -->
...
<body>
	...
	<section style="padding-top: 20px;">
	  <div class="container text-center">
	    ...
	    <h3 class="mt-3">VI. REPRECENTANTE LEGAL</h3>
	  </div>
	</section>
	<!-- Fin Section Texto -->
	  ...
	  <div class="row">
	    <div class="col-12">
	      <div class="bg-info p-3 mb-3">
	        <h3 class="text-white mb-0">VI. REPRECENTANTE LEGAL</h3>
	      </div>
	      <form id="frmFormulario" method="post" action="ServletLegal?accion=grabar">
	        <div class="row mb-3">
	          <div class="col-4">
	            <div class="form-group">
	              <label for="select1" class="form-label">¿ACTUA EN REPRECENTACION DE OTRA PERSONA NATURAL?</label>
	              <select class="form-select" name="personaNatural" id="id-personaNatural">
	        ...
	        <div class="row d-flex justify-content-between">
	          ...
	          <div class="col-1 ps-0">
	            <a href="DatosAdicionalNegocio.jsp" class="btn btn-primary w-45 ms-2">Regresar</a>
	          </div>
	          <div class="col-1 ps-0">
        ...
        $('#frmFormulario').bootstrapValidator({      
        	 fields:{
        		 personaNatural:{
        			 validators:{
        				 notEmpty:{
        					 message:'Campo persona Natural es obligatorio, Rsponda SI o NO'
        				 } 
        			 }
        		 }
        	 }
