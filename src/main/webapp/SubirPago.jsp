...
<body>
	...
	<header class="bg-primary text-white">
	  <div class="container py-3">
	    <h1 class="text-center">Adjunte Su Comprobante de Pago</h1>
	  </div>
	</header><br><br>
	<!-- Fin section Header -->
	  ...
	  <div class="row">
	    <div class="col-12">
	      <div class="bg-info p-3 mb-3">
	        <h3 class="text-white mb-0">RELLENE LOS CAMPOS</h3>
	      </div>
	      <form id="frmSubirPago" method="post" action="ServletPago?accion=grabar" enctype="multipart/form-data">
	        <div class="row mb-3">
	          <div class="col-3 form-group">
	            <label for="select1" class="form-label">NOMBRE Y APELLIDO</label>
	            <input type="text" class="form-control" name="nombreApellido" id="id-nombreApellido">
	          </div>
	          <div class="col-3 form-group">
	          ...
	          <div class="col-3 form-group">
	            <label for="select1" class="form-label">ADJUNTE PAGO</label>
	        ...
	        <div class="row d-flex justify-content-between">
	          <div class="col-5 pe-0">
	            <a href="RepresentanteLegal.jsp" class="btn btn-primary w-45 ms-2">Regresar</a>
	          </div>
